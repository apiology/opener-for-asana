...
Opener for Asana | right click | Export ... | Export | choose this
directory | Export
...
1. Finalize [promotional image](docs/opener-for-asana.paint).
1. Stage the .paint file in git.
1. File | Save As... | png | `opener-for-asana-440x280.png` | Save
